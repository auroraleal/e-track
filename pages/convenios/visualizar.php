      ...
      <!-- left column -->
    	...
    	<div style="margin-left: 100px" class="col-md-10">
          <!-- general form elements -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Visualizar Convênio</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="../../controllers/convenios/new-conv.php" method="post">
              	<div class="col-md-4">
	                  ...
	                  <select disabled="true" class="form-control" name="secretaria">
		        ...
		        <div class="col-md-2">
		        	<div class="form-group">
                  		<label>Ano</label>
                  		<input type="text" disabled="true" value="<?=$results['ano']?>" class="form-control" placeholder="Digite o Ano" name="ano">
                	</div>
		        </div>
		        <div class="col-md-4">
		        	<div class="form-group">
                  		<label>Orgão</label>
		                  <select class="form-control" name="orgao" disabled="true">
		                    <option value="">Selecione</option>
                      <?php
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled="true" placeholder="" name="numero" value="<?=$results['numero']?>">
                </div>
            </div>
                ...
                <div class="col-md-2">
		        	<div class="form-group">
                  		<label>Início</label>
		                <input type="text" class="form-control" disabled="true" placeholder="" name="inicio" value="<?=$data_inicio?>">
                	</div>
		        </div>
		        ...
		        <div class="col-md-2">
		        	<div class="form-group">
                  		<label>Término</label>
		                <input type="text" disabled="true" value= "<?=$data_termino?>"class="form-control" placeholder="" name="termino">
                	</div>
		        </div>
                ...
                <div class="form-group">
                  <label>Origem</label>
                  <input type="text" class="form-control"  disabled="true" placeholder="" name="origem" value="<?=$results['origem']?>">
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <select class="form-control" name="tipo_convenio_id" disabled="true">
		                     <option value="">Selecione</option>
                      <?php
        ...
        <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled="true" placeholder="" name="numero_sincov" value="<?=$results['numero_sincov']?>">
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled="true" placeholder="" name="num_convenio" value="<?=$results['numero']?>">
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <select class="form-control" name="empenhado" disabled="true">
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <select class="form-control" name="termo" disabled="true">
                      <option value="">Selecione</option>
                      <?php
            ...
            <div class="col-md-2">
                <div class="form-group">
                  <label>Repasse</label>
                  <input type="text" class="form-control" disabled="true" placeholder="" name="repasse" value="<?=$results['repasse']?>">
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled="true" placeholder="" name="contrapartida" value="<?=$results['contrapartida']?>">
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  <label>Ação</label>
                 <select class="form-control" name="acao" disabled="true">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  <label>Objeto</label>
                  <textarea class="form-control" rows="3" placeholder="texto" name="objeto" disabled="true"><?=$results['objeto']?></textarea>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled="true" placeholder="" name="valor_global" value="<?=$results['valor_global']?>">
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled="true" placeholder="" name="valor_repasse" value="<?=$results['valor_repasse']?>">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                  <label>Valor contrapartida</label>
                  <inputut  type="text" class="form-control" disabled="true" placeholder="" name="valor_contrapartida" value="<?=$results['valor_contrapartida']?>">
                </div>
            </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="texto" name="situacao" disabled="true"><?=$results['situacao']?></textarea>
                </div>
            </div>
</div>
