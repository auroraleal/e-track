          ...
          <!-- general form elements -->
            ...
            <div class="box-body">
              ...
              <form role="form" action="../../controllers/operador/confirmar-carga.php" method="post">
                ...
                <?php } ?>
                <?php if ($_SESSION['perfil'] == 'Operador ETC' ||
                          $_SESSION['perfil'] == 'Administrador') { ?>
                  <div class="row">
                    <div class="col-md-6">
...
<?php if (!$erro) { ?>
            <div class="box-footer">
              <button onclick="return confirm('Deseja realmente confirmar?')" type="submit" class="btn btn-danger" style="margin-left: 15px">Confirmar</a> 
            </div>
